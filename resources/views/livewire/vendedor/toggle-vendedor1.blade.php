<div class="toggle-de-vendedores-activos">
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <!--Contenido-->
                ...
                <div class="mx-4 mb-0 mt-2">
                    <h2 class="text-2xl font-bold">Inactivar Vendedor</h2>
                    <p class="text-xl font-normal pt-1">¿Estás seguro con innactivar al vendedor <span class="font-semibold">{{$user->name}}</span>?</p>
                </div>
