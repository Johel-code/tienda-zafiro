<div class="toggle-de-vendedores-inactivos">
    <label class="relative inline-flex cursor-pointer items-center top-1">
        <input wire:model="isActive" type="checkbox" value="" class="sr-only peer" id="{{$field.$user->id}}">
        <span for="{{ $field.$user->id }}" class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-3 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#3988FF]"></span>
    </label>
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <!--Contenido-->
                ...
                <div class="mx-4 mb-0 mt-2">
                    <h2 class="text-2xl font-bold">Activar Vendedor</h2>
                    <p class="text-xl font-normal pt-1">¿Estás seguro con activar nuevamente al vendedor <span class="font-semibold">{{$user->name}}</span>?</p>
                </div>
    ...
    <div class="fixed inset-0 z-20">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <!--Contenido-->
                ...
                <div class="mx-4 mb-0 mt-2">
                    <h2 class="text-2xl font-bold">Contrato Vencido</h2>
                    <p class="text-xl font-normal pt-1">No puedes activar éste vendedor, por favor cambia la fecha fin contrato para activar.</p>
                </div>
