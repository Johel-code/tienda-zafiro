            ...
            <div class=" text-white">
                <div class="inline-block align-top {{$with_reponsivos}}">
                    <ul class="fixed z-10 py-0 space-y-1 {{$with_reponsivos}} bg-[#021633] h-full">
                        ...
                        <li>
                            @can('Admin.vista')
                                <a href="/pre-factura" class="relative flex flex-row justify-between items-center h-11 focus:outline-none hover:bg-[#597AAB] focus:bg-[#597AAB] text-white-600 hover:text-white-800 focus:text-white-800 border-l-4 border-transparent hover:border-blue-500 focus:border-blue-500 dark:hover:border-gray-800 pl-1 pr-0 {{ request()->is('pre-factura') ? 'bg-[#597AAB]' : '' }} {{ request()->is('factura') ? 'bg-[#597AAB]' : '' }}">
                                    <span class="hidden {{$smblock}} sm:ml-1 md:ml-6 text-[15px] font-anek font-medium">Ventas</span>
                                    <svg class="{{$smhidden}}" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="33" viewBox="0 -960 960 960" width="33"><path d="m480-574-42-42 74-74H330v-60h182l-74-74 42-42 146 146-146 146ZM289.788-80Q260-80 239-101.212q-21-21.213-21-51Q218-182 239.212-203q21.213-21 51-21Q320-224 341-202.788q21 21.213 21 51Q362-122 340.788-101q-21.213 21-51 21Zm404 0Q664-80 643-101.212q-21-21.213-21-51Q622-182 643.212-203q21.213-21 51-21Q724-224 745-202.788q21 21.213 21 51Q766-122 744.788-101q-21.213 21-51 21ZM62-820v-60h116l170 364h287.706L796-796h67L701-493q-11 19-28.559 30.5Q654.881-451 634-451H331l-56 104h491v60H284q-37.663 0-57.332-30Q207-347 224-378l64-118-148-324H62Z"/></svg>
                                </a>
                            @endcan
                        </li>
