<div>
    <div>
        <div class="relative bottom-10 w-80 ml-96 left-80 pl-48">
            <input wire:model="searchTerm" type="search"  class=" p-2.5 w-80 z-20 text-sm text-gray-900 bg-gray-50 rounded-lg border-l-gray-300 border border-gray-300 focus:ring-gray-300 focus:border-gray-300" placeholder="Buscar">
