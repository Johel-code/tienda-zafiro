<div>
    <div>
        <div class="flex flex-row place-content-between">
            <div class=" lg:ml-72 md:ml-72 sm:ml-8">
            ...
            <div class=" lg:mr-8 md:mr-8 sm:mr-8">
                <input wire:model="search" type="search"  class=" p-2.5 w-auto sm:w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border-l-gray-300 border border-gray-300 focus:ring-gray-300 focus:border-gray-300" placeholder="Buscar">
