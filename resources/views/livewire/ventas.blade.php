            ...
            <table class="md:table-fixed w-full font-anek">
                <thead class="h-12">
                    <tr class="text-dark">
                        ...
                        <th class="2xl:text-lg text-center text-ellipsis overflow-hidden border-b border-black">Nombre</th>
                ...
                <tbody>
                    <tr class="hover:bg-blue-200">
                        <td class="cursor-pointer px-3 py-1 2xl:py-3 2xl:text-lg t xt-center text-ellipsis overflow-hidden"> 4565
                        </td>

                        <td class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis md:overflow-hidden ms:overflow-hidden  whitespace-nowrap">Patito 500 gr
                        </td>

                        <td class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis overflow-hidden">10</td>
                        
                        <td class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis overflow-hidden">12</td>

                        <td class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis overflow-hidden">120</td>

                        <td class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis overflow-hidden">Quitar</td>
                    </tr>
