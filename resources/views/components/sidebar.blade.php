<!-- Sidebar -->
<div class="fixed flex flex-col top-14 left-0 md:w-64 bg-[#021633] h-full text-white border-none">
    <div class="overflow-y-auto flex flex-col justify-between flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
            <li>
                <a href="products" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#597AAB] text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
