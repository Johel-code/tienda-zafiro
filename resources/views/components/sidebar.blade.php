<!-- Sidebar -->
<div class="fixed flex flex-col top-14 left-0 md:w-32 lg:w-64 bg-[#021633] h-full text-white border-none">
    <div class="overflow-y-auto flex flex-col justify-between flex-grow md:w-32 lg:w-64">
